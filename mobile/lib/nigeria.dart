...
/// `region` field on case reports and ADRs. Region is stored as "LGA, State".
/// ponytail: static data, not an API. Move server-side only if LGA boundaries
/// start changing (they don't, often).
